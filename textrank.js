...
function ejecutarTextRank(texto) {
  // Lista de palabras vacías en español
  const spanishStopwords = new Set([
    'un', 'una', 'y', 'es', 'en', 'el', 'la', 'los', 'las', 'de', 'para', 'con', 'su', 'sus'
  ]);
